...
public class Yilyakunlari extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yilyakunlari);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.yilyakunlari, menu);
        return true;
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.news) {
            Intent intent = new Intent(Yilyakunlari.this, NewsActivity.class);
            startActivity(intent);
            // Handle the camera action
        } else if (id == R.id.nav_dav) {
            Intent intent = new Intent(Yilyakunlari.this, Davlatdasturi.class);
            startActivity(intent);
        } else if (id == R.id.nav_harakat) {
            Intent intent = new Intent(Yilyakunlari.this, HarakatlarSActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_slideshow) {
            Intent intent = new Intent(Yilyakunlari.this, Yilyakunlari.class);
            startActivity(intent);
        }
   ...
   /* public void nextImage(View view) {
    ...
    private void loadPhotosDynamically() {
        photoViewSlider.setPhotoUrl("http://www.wired.com/wp-content/uploads/2014/10/lollipop_005.jpg");
